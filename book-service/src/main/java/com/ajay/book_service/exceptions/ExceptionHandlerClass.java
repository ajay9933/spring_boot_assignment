...
public class ExceptionHandlerClass {
    ...
    public ResponseEntity<CustomExceptionClass> handleUsernameExceptions(BookExistsException exc) {
    ...
    @ExceptionHandler
    public ResponseEntity<CustomExceptionClass> handleException(InvalidBookException exc){
        CustomExceptionClass custom=new CustomExceptionClass();
        custom.setMessage(exc.getMessage());
    ...
    @ExceptionHandler
    public ResponseEntity<CustomExceptionClass> handleAuthorNtFoundExceptions(BookNotFoundException exc) {
        CustomExceptionClass custom = new CustomExceptionClass();
        custom.setMessage(exc.getMessage());
